...
DESCRIPTION = 'Collection of Functions and Scripts for Medical Image Processing'
URL = 'https://github.com/RiccardoBiondi/ImageProcessingTools'
EMAIL = 'riccardo.biondi7@unibo.it'
AUTHOR = 'Riccardo Biondi'
VERSION = None
KEYWORDS = 'medical-imaging segmentation python '
...
setup(
    ...
    download_url=URL,
    keywords=KEYWORDS,
    packages=find_packages(include=['IPT','IPT.*'], exclude=('test', 'testing')),
